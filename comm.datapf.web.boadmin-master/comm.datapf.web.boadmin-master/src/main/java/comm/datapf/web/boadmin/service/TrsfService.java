...
public interface TrsfService {
    ApiSuccess doSelectGranter(HashMap<String, Object> input) throws Exception;

    ApiSuccess doSelectReceiver(HashMap<String, Object> input) throws Exception;

    ApiSuccess doSelectPymnt(HashMap<String, Object> input) throws Exception;

    ApiSuccess doUpdateTrsf(UpdateTrsfParamVo param) throws Exception;
