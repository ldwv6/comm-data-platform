...
@Getter
@Setter
public class ClsgRvnuGroupDto {

    private String prdtCtgrCd;  /*  AS 상품 카테고리      */
    private String prdtCtgrNm;  /*  대표상품 카테고리명(코드-PRDT_CTGR_NM)    */
    private String rvnuTypeCd;  /*  매출유형              */
    private String rvnuTypeNm;  /*  매출유형명            */
    private String taxTypeCd;   /*  과면세유형            */
